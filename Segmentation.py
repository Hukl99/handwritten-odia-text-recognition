...
#for keras model
model = keras.models.load_model('model.weights.best.keras')
...
model = Sequential([
    Input(shape=(1600,)),
    Dense(128, activation='relu'),  # adjust input shape
    Dense(64, activation='softmax')  # match the weights (64 outputs)
])
